...
download.file('https://www.dropbox.com/s/pyg5iu71xme2qnq/grados.xlsx?dl=1', 'grados.xlsx')

library(readxl) # librería que permite leer archivos de excel
grados <- read_excel("grados.xlsx") # Habiendo ubicado el directorio de trabajo
