...
lines(density(wage, adjust=2), col="orange", lwd=3, lty=2) 
lines(density(wage), col="red", lwd=3)  # distribucion empirica
curve(dnorm(x, mean=mean(wage), sd=sd(wage)), add=TRUE, col="green", lwd=3)  # distribucion simulada
abline(v=mean(wage), lwd=2, lty=3, col="blue")    # posición de la media
```
Boxplot
```{r}
boxplot(wage ~ gender,
        main = "Salario por género",
        ylab = "Salario",
        xlab = "Género",
...
plot (log(wage) ~ experience,
      pch = sexo,
      col = sexo,
      main = "Salario a partir de la experiencia",
...
Bibliografía:
        ...
        1. Videotutorial: https://youtu.be/vAl--JPLXno

        2. R para principiantes. Bookdown.  https://bookdown.org/jboscomendoza/r-principiantes4/introduccion-que-es-r-y-para-que-es-usado.html 
    
        3. Curso de introducción a R. UV. https://www.uv.es/vcoll/preliminares.html
